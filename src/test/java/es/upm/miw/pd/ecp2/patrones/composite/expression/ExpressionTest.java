...
import es.upm.miw.pd.ecp2.patrones.composite.expression.Dividir;
import es.upm.miw.pd.ecp2.patrones.composite.expression.Expresion;
import es.upm.miw.pd.ecp2.patrones.composite.expression.Multiplicar;
import es.upm.miw.pd.ecp2.patrones.composite.expression.Numero;
import es.upm.miw.pd.ecp2.patrones.composite.expression.Restar;
import es.upm.miw.pd.ecp2.patrones.composite.expression.Sumar;
