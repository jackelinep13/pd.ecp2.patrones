...
import es.upm.miw.pd.patrones.text.Componente;
import es.upm.miw.pd.patrones.text.FactoriaCaracter;
import es.upm.miw.pd.patrones.text.Parrafo;
import es.upm.miw.pd.patrones.text.Texto;
